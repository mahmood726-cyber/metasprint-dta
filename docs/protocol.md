        # Metasprint Dta: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/metasprint-dta.git

        ## Objective

        MetaSprint DTA is a 29K-line automated diagnostic test accuracy meta-analysis pipeline with ~2,300 validated tests.
        ...
        - Code: https://github.com/mahmood726-cyber/metasprint-dta.git
        - Dashboard: https://mahmood726-cyber.github.io/metasprint-dta/
